          ...
          <div class="swiper myHeroSwiper">
            <div class="swiper-wrapper">
              <div
                ...
                style="background-image: url('/assets/banners_hero_section/man.jpg');"
              >
                <div class="overlay"></div>
                <div class="content">
                  <span class="badges">Next Gen Gear</span>
                  <h1 class="title">DOMINATE THE <br /><span class="blue">GAMING</span> WORLD</h1>
                  <p class="desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur hic velit, eligendi molestias nobis modi.</p>
                  <div class="buttons">
              ...
              <div
                class="swiper-slide hero-slide"
                style="background-image: url('/assets/banners_hero_section/woman.jpg');"
              >
                <div class="overlay"></div>
                <div class="content">
            ...
            <div class="swiper mySwiper">
              <div class="swiper-wrapper">
                ...
                foreach ($all_products as $product) {
                    // Filtrer les chaises (IDs de 1 à 5)
                      ...
                      <div class="swiper-slide">
                        <div class="p-card">
                          <a href="shop-details.html?id=<?= $product['id']; ?>">
                            <div class="p-img">
                              <img src="<?= $product['main_image']; ?>" alt="<?= htmlspecialchars($product['name']); ?>" class="main-img" />
                              <img src="<?= $product['main_image']; ?>" alt="<?= htmlspecialchars($product['name']); ?>" class="hover-img" />
                            </div>
                          </a>
                          <div class="p-details">
                            ...
                            <div class="p-stock">
                              <span class="dott"></span> <?= htmlspecialchars($product['status']); ?>.
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <section class="tech-collection desks" id="desk-section">
        ...
        <div class="product-grid swiper deskSwiper">
          <div class="swiper-wrapper">
            <?php 
            foreach ($all_products as $product) {
                // Filtrer les bureaux (IDs de 6 à 10)
            ...
            ?>
                  <div class="swiper-slide">
                    <div class="p-card">
                      <a href="shop-details.html?id=<?= $product['id']; ?>">
                        <div class="p-img">
                          <img src="<?= $product['main_image']; ?>" class="main-img" alt="<?= htmlspecialchars($product['name']); ?>" />
                          <img src="<?= $product['main_image']; ?>" class="hover-img" alt="<?= htmlspecialchars($product['name']); ?>" />
                        </div>
                      </a>
                      <div class="p-details">
                        <span class="p-brand"><?= htmlspecialchars($product['brand']); ?></span>
      ...
      <section class="tech-collection controllers" id="controllers-section">
        ...
        <div class="product-grid swiper ControllerSwiper">
          <div class="swiper-wrapper">
            <?php 
            foreach ($all_products as $product) {
                // Filtrer les manettes (IDs de 11 à 16)
                if ($product['id'] >= 11 && $product['id'] <= 16) {
            ?>
                  <div class="swiper-slide">
                    <div class="p-card">
                      <a href="shop-details.html?id=<?= $product['id']; ?>">
      ...
      <section class="tech-collection PlayStation" id="playStation-section">
        ...
        <div class="product-grid swiper playstation-swiper">
          <div class="swiper-wrapper">
            <?php 
            foreach ($all_products as $product) {
                // Filtrer les consoles PlayStation (IDs de 17 à 20)
      ...
      <section class="tech-collection mous" id="mous-section">
        ...
        <div class="product-grid swiper mous-swiper">
          <div class="swiper-wrapper">
            <?php 
            foreach ($all_products as $product) {
                // Filtrer les souris (IDs de 21 à 24)
                if ($product['id'] >= 21 && $product['id'] <= 24) {
            ?>
                  <div class="swiper-slide">
                    <a href="shop-details.html?id=<?= $product['id']; ?>">
                      <div class="p-card">
      ...
      <section class="tech-collection Ecran" id="ecran-section">
        ...
        <div class="product-grid swiper ecran-swiper">
          <div class="swiper-wrapper">
            <?php 
            foreach ($all_products as $product) {
                // Filtrer les écrans (IDs de 25 à 28)
                if ($product['id'] >= 25 && $product['id'] <= 28) {
            ?>
                  <div class="swiper-slide">
                    <a href="shop-details.html?id=<?= $product['id']; ?>">
                      <div class="p-card">
    ...
    <footer class="footer">
      <div class="footer-container">
        <div class="footer-section brand-info">
          <h2 class="brand-name">Thec shop</h2>
          <p class="description">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloribus magnam minus possimus laudantium provident, molestiae, laborum culpa optio dolor sapiente ad unde ipsum facilis accusamus.</p>
      ...
      <div class="footer-bottom">
        <p>2026 <strong>Thec shop</strong>. All rights reserved</p>
      </div>
    </footer>
